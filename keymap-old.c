 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Caps | Menu | GUI  | ALT  |Space |Lower |Raise |Shift | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {KC_CAPS, KC_MENU, KC_LGUI, KC_LALT, KC_SPC,  LOWER,   RAISE,   KC_LSFT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Caps | menu | GUI  | Atl  |Space |Lower |Raise |Shift | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_DVORAK] = {
 ...
 */
[_ADJUST] = {
  {_______, _______, _______, _______, _______, QWERTY,  DVORAK,  KC_VOLU, KC_VOLD, KC__MUTE,_______, M(1)   },
